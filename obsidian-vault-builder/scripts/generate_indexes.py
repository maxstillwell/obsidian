...
parser = argparse.ArgumentParser(description="Regenerate missing index scaffold files.")
...
print(f"Ensured index scaffold in {result.vault_path}. Created files: {len(result.created_files)}")
