...
| 资产名称 |  |
| 地点 |  |
| 资产类型 | 成熟园 / 新园 / 混合 / 问题资产 / 纯土地 |
| 估值日期 |  |
| 估值用途 | 交易 / 抵押 / 内部投资 / 税务 / 重组 |
| 估值口径 | Site Value / CIV / As Is Market Value / Alternative Use |
...
| 字段 | 内容 | 备注 |
| --- | --- | --- |
| 产量（t/ha） |  | 核心 benchmark |
| Revenue / ha |  | 收入强度 |
| Cash Cost / ha |  | 成本强度 |
| Gross Margin / ha |  | 核心经营结果 |
| 出仁率 / 回收率 |  | 适用于果园类资产 |
| 树龄 / 成熟度 |  | 适用于果园类资产 |
| 经营状态 | 正常 / 过渡 / 亏损 / 待处置 |  |
...
- `Site Value / ha = Site Value ÷ 总面积`
- `CIV / ha = CIV ÷ 总面积`
- `Value / planted ha = 估值 ÷ 已种植面积`
- `Gross Margin / ha = Revenue / ha - Cash Cost / ha`
- `Debt / Value = 总债务 ÷ 资产估值`
- `Capex Gap = 达到目标产能所需追加投资`

### 7.6 最终输出格式

每个农场最终都建议给出四个结论：

1. **资产质量**：优质 / 中性 / 偏弱 / 问题资产  
2. **经营质量**：高 / 中 / 低  
3. **估值逻辑**：地值驱动 / 经营驱动 / 改良驱动 / 处置驱动  
4. **投资动作**：买入 / 持有 / 追加投入 / 重组 / 处置

## 8. 相关对比总表

- [[20_Knowledge/农场Benchmark横向对比总表]]
