...
**日期：2026年9月25日**  
**用途：股东内部讨论 / 投资决策参考**  
**口径更新：土地总面积按 142.49 ha；纳入 Dunoon Village Growth Area 的面积按 101.69 ha。**  
**说明：本文为内部投资分析，不构成独立估值、法律意见或规划批准承诺。除特别说明外，金额均为澳元。**

---

## 1. 项目现状

项目位于 NSW Lismore City Council 辖区 Dunoon，现状为一处大型夏威夷果农场。

| 项目 | 最新核定口径 |
|---|---:|
| **土地总面积** | **142.49 ha（1,424,900㎡）** |
| **纳入未来增长区的面积** | **101.69 ha（1,016,900㎡）** |
| **增长区面积占项目总面积** | **71.37%** |
| **未纳入增长区的面积** | **40.80 ha（408,000㎡）** |
| **未纳入增长区面积占比** | **28.63%** |
...
纳入未来增长区  101.69 ha  ████████████████████████████████████  71.37%
其余农业用地     40.80 ha  ██████████████                        28.63%
```

### 历史估值与农业经营

- 2019年 Herron Todd White 正式估值报告的 “As Is” Market Value 为 **A$6.765m（ex GST）**
- 该估值报告记载的面积为 **142.95 ha**，与目前项目提供的准确面积 **142.49 ha** 相差 **0.46 ha**。该差异应在产权、测量及合同尽调中核对。
- 根据项目方提供的信息，当前夏威夷果业务受市场价格及经营成本影响，基本不盈利。因此，本项目的主要投资回报不依赖农业利润增长，而依赖规划去风险及土地用途提升。

### 加工厂安排

据项目方提供，刘总于去年底投入约 **A$4.0m** 建设夏威夷果加工厂。加工厂原则上不纳入本次土地开发投资：
...
本项目进入增长区的面积为 **101.69 ha**，占整个 Dunoon Village Growth Area 的：
...
2. **下一步：NSW State Government / DPHI endorsement。**目前管理层工作假设为 **3–6个月**，该时间并非公开法定承诺，将由我方直接与州政府及 Council 进一步确认。
...
A$8.0m 对应 142.49 ha，名义收购单价为：

**A$56,144/ha = A$5.61/㎡**

按目前测算的 NSW Stamp Duty 约 **A$421,287** 计，土地及印花税合计约 **A$8.421m**，对应：

**A$59,101/ha = A$5.91/㎡**

以上尚未计入律师、尽调、规划顾问、融资、Land Tax及后续审批费用。
...
| **本项目** | 2026 | **142.49 ha** | **A$8.0m** | **5.61** |
...
上述四个参考交易的未加权中位单价约为 **A$6.64/㎡**。本项目名义买入单价 **A$5.61/㎡**，较该中位数低约 **15.4%**。但各参考物业的住宅、果园、基础设施和改善物不同，因此该比较仅用于判断大致价格区间，不能替代正式估值。
...
> **以接近当地农村土地的整体价格，取得一项71.37%的土地面积已经进入未来住宅增长框架、并控制整个Dunoon增长区约28.09%面积的资产。**
...
Council 对整个 Dunoon Village Growth Area 的战略预期为 **362 ha / 434 homes**，对应区域平均战略密度：

**434 ÷ 362 = 1.20套/ha**

若完全按照面积比例分配，本项目 101.69 ha 对应：

**101.69 × 434 ÷ 362 = 121.92套，即约122套住宅。**

因此，**约122套**应视为当前最保守的面积比例基准，而不是已经批准的开发权，也不是项目最终目标。

### 规划目标对比

| 情景 | 住宅数量 | 对应增长区土地密度 | 相对约122套基准 | 占当前434套战略总量 |
|---|---:|---:|---:|---:|
| **保守面积比例基准** | **约122套** | **约1.20套/ha** | — | **约28.1%** |
| **第一阶段规划目标** | **约200套** | **约1.97套/ha** | **提高约64%** | **约46.1%** |

这说明，200套目标并非简单按土地面积自然取得，而需要 Council / State Government 对 Eco-village、集中式污水处理、更高土地利用效率及公共设施安排给予明确支持。
...
> **从约122套提高至约200套，是我方加入项目后最重要的主动价值创造工作。**

同时，200套对应的密度约为区域面积比例基准的 **1.64倍**，因此应作为积极争取的规划目标，而非基础承诺。
...
| **Master Plan — 约122套** | 保守面积比例密度得到确认 | **A$10.5m–12.5m** |
...
> 面积由此前的约140 ha / 103–105 ha 更新为 142.49 ha / 101.69 ha 后，保守住宅基准由约125套修正为约122套。由于阶段估值本身为宽区间、且主要受规划确定性和基础设施成本影响，现阶段不宜因3套的差异对估值区间作虚假精确调整。
...
拟由我方取得 **50%–60%权益**，其余 **40%–50%** 由刘总及其团队持有，并可能包括 Wenny。
...
> **控制权提示：**50%股权通常属于共同控制，未必形成单方面控制；若我方计划以50%股权取得实质控制，需要在股东协议中明确董事会席位、保留事项、预算审批、追加资本、出售权、违约机制及 casting vote。55%–60%则属于多数股权，但仍需完善股东协议。
...
**第一，买入价格具有较好的防守性。**  
项目名义收购单价约 **A$5.61/㎡**；即使计入一般 Stamp Duty，约为 **A$5.91/㎡**。该价格仍与周边农村物业成交水平接近，而项目有 **101.69 ha、即71.37%的土地**已经进入未来增长区。

**第二，项目在 Dunoon Growth Area 中占比较大。**  
项目占整个增长区面积约 **28.09%**，接近三成，属于区域 Master Plan 中不可忽视的主要土地持有者，有条件在规划过程中进行持续、系统的政府沟通。

**第三，存在多个退出节点。**  
State endorsement、Master Plan、Gateway、Rezoning、DA 均可能形成不同程度的价值重估，不必将投资锁定到最终开发阶段。

**第四，密度提升具有显著价值弹性。**  
约122套是面积比例基准，第一阶段目标约200套。若 Master Plan 最终接受更高密度，项目价值将显著高于单纯按照区域平均密度的土地价值。
...
**2. 密度风险。**  
200套目标较面积比例基准约122套高约 **64%**。最终住宅数量取决于 Council / State 对污水、道路、生态、开放空间及基础设施的综合判断。我们可以通过规划设计和政府沟通管理这一风险，但不能完全消除。
...
**5. 加工厂产权分割风险。**  
约3,000㎡加工厂地块未来独立产权安排必须在交易文件中明确，并解决长期 access、services 和 easement 问题。还需确认该地块从项目剥离后，对142.49 ha总面积、101.69 ha增长区面积和可开发住宅数量的影响。

**6. 面积及产权口径风险。**  
2019年估值报告面积为142.95 ha，而目前项目准确口径为142.49 ha，差异0.46 ha。正式投资决策前应以最新title search、survey及合同schedule统一口径。
...
2. **Master Plan 是否能在约12个月的工作假设内形成；**
3. **101.69 ha增长区面积是否在后续 Master Plan 中完整保留；**
4. **住宅密度能否由面积比例基准约122套提高至第一阶段目标约200套；**
5. **每个规划节点的市场报价是否已经达到合理退出水平。**

### 项目一句话总结

> **本项目拟以A$8.0m收购一项总面积142.49 ha的夏威夷果农场，其中101.69 ha、即71.37%的土地已进入Dunoon未来住宅增长框架，并占整个增长区约28.09%。项目将通过Master Plan、Eco-village、集中式污水方案及政府沟通，将面积比例基准约122套提高至第一阶段约200套目标，在3–5年的规划去风险过程中择机出售，而不承担最终住宅开发风险。**

---

## 资料来源及口径说明

- 项目方最新提供面积口径：总面积 **142.49 ha**；纳入 Dunoon Village Growth Area 面积 **101.69 ha**。
...
- Herron Todd White, *Valuation Report – 1306 Dunoon Road, Dunoon*, 26 Aug 2019。正式结论：“As Is” Market Value A$6.765m ex GST；报告面积142.95 ha。
...
- 本报告中的3–6个月 State endorsement、约12个月 Master Plan及后续阶段时间均为现阶段管理层工作假设，并非 Council 或 NSW Government 的法定完成承诺，需继续通过官方沟通确认。
