...
![](assets/Dunoon%20项目投资概况v3/file-20260925103326391.png)![](assets/Dunoon%20项目投资概况v3/file-20260925103344840.png)![](assets/Dunoon项目v2/file-20260925100937140.png)
需要区分两个阶段：
...
以下仅作为内部投资模型，采用 **2026年当前市场价值，不假设未来房价上涨；实际价值最终取决于 Master Plan 密度、基础设施成本、市场环境及开发商风险偏好。
...
| **Gateway / Rezoning 关键阶段 — ** | 法定 rezoning 路径大幅去风险                |     **A$15m–20m** |
| **DA Approved — **             | 形成可直接交由开发商实施的项目                    |     **A$18m–23m** |
...
因此，项目的管理重点不是等待市场自然上涨，而是主动缩短规划时间并提高可确认的住宅 yield，上述的价值区间对应相应的密度。

---

## 7. 投资结构及资金投入

拟由我方取得 **50%–60%权益**，其余 **40%–50%** 由刘总及其团队持有。
...
1. **State endorsement 是否按3–6个月工作假设推进；**（已经在约当地政府和规划师）
2. **Master Plan 是否能在约12个月的工作假设内形成；**
3. **101.69 ha增长区面积是否在后续 Master Plan 中完整保留；**
4. **住宅密度能否由面积比例基准约122套提高至第一阶段目标约200套的可能性；**
5. **交易的主体，结构，股权比例，交割周期**。
