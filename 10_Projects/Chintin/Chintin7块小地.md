...
As discussed previously, we own several farming properties in Victoria. One of the key sites is located at **Chintin**, and we are currently considering potential residential development across **seven parcels of land**.

I have attached the **planning reports and Title Map** for these parcels for your reference. If you need, I can also share drone photos and videos for further understanding of the lands.

Before we proceed with any town planning application or architectural design, we would really appreciate your **initial planning advice** regarding the following matters.

---

### 1. Dwelling entitlement for each parcel

We understand that all seven parcels are currently within the **Farming Zone**.

Could you please advise whether **each title is entitled to have its own dwelling**?

In other words, is it possible to construct **one house on each individual title**?

If this is allowed, would it typically require:

- a **Planning Permit from Council**, or
    
- only a **Building Permit**, provided it complies with the planning scheme?
    

---

### 2. Planning requirements for residential development

If residential dwellings are permitted on these parcels, could you please advise what **local planning requirements** we would need to follow?
...
- Any council-specific development guidelines
    
- Other relevant planning controls for rural residential development
    

---

### 3. Planning scheme and development controls

If possible, could you also provide guidance on the **relevant planning scheme controls**, such as:

- Site coverage limits
    
- Landscaping requirements
    
- Any design guidelines or rural building controls
    
- Other key planning considerations applicable to this land
    

If there are **specific planning scheme clauses or design guidelines** we should review, it would be very helpful if you could point us in the right direction.

---

### 4. Creek / flood planning considerations

There appears to be a **creek running through part of the land**.

Could you please advise:

- whether there are any **flooding or waterway planning controls** affecting the site
    
- whether **Melbourne Water** would be involved in planning approvals
    
- and whether any **setbacks or restrictions** may apply near the creek
...
We would greatly appreciate any **initial advice or guidance** you can provide before we move forward with further planning or design work.
...
Apologies for the delay in getting this across to you. We have undertaken an initial review of the parcels and provided an overview of the relevant controls and dwelling entitlements below.

All of the parcels are located within the Farming Zone (FZ). The purpose of the FZ is:
...
Any application for use and/or development will need to respond to the above stated purpose.

Under the FZ, the following requirements apply:

- Minimum subdivision area – each lot created must be a minimum of 40ha
- Minimum area for which no permit is required to use the land as a dwelling – 40ha
- Minimum setback from a road

- 100m from a road in a Transport 2 Zone
- 20m from any other road

- Minimum setback from a boundary – 5m
- Minimum setback from a dwelling not in the same ownership – 100m

We note from a review of the aerial imagery, there does not appear to be any existing dwellings on any of the lots however we note there is significant vegetation across a large portion of the site. Consideration will need to be given to the value of this vegetation and whether any of it is considered to be native vegetation as this may influence your ability to clear vegetation on the land.

In addition, we note the sites are not affected by any flooding control overlays such as a Special Building Overlay, Flood Overlay or Land Subject to Inundation Overlay.

A number of the sites are affected by the Bushfire Management Overlay, pursuant to which a bushfire hazard assessment, a bushfire landscape assessment and a bushfire management statement would need to be prepared as part of any future development application. Consideration will also need to be given to construction standards and access arrangements as well as the provision of defendable space and water supply.

|   |   |   |   |   |   |
|---|---|---|---|---|---|
|**Map reference**|**Volume/folio**|**Description**|**Area (Ha)**|**Planning Controls**|**Permitted dwellings**|
|1|7163/559|Crown Allotment 15C Section A Parish of Chintin|19.50|Farming zone (FZ)<br><br>Bushfire Management Overlay (BMO)|Pursuant to the BMO a permit would be required to construct a dwelling. Any application would need to be supported by a bushfire hazard assessment, a bushfire landscape assessment and a bushfire management statement. Given the extent of vegetation on the site careful consideration will need to be given to the design and siting of any dwelling on the site.<br><br>Given the site is under 40 ha, a permit would also be required to construct a dwelling on the site. One small second dwelling may also be permitted however would be subject to meeting various conditions and would require Council approval.|
|2|11216 / 466|Lot 1 Plan of Subdivision 529130N|40.58|FZ<br><br>BMO|Pursuant to the BMO a permit would be required to construct a dwelling. Any application would need to be supported by a bushfire hazard assessment, a bushfire landscape assessment and a bushfire management statement. Given the extent of vegetation on the site careful consideration will need to be given to the design and siting of any dwelling on the site.<br><br>Pursuant to the FZ, no permit would be required for the use of the land as a dwelling provided the requirements in Clause 35.07-2 are met. In addition, one small second dwelling would be permitted as of right provided the requirements in Clause 35.07 are met.|
|3|11216 / 467|Lot 2 Plan of Subdivision 529130N|40.35|FZ<br><br>BMO|Pursuant to the BMO a permit would be required to construct a dwelling. Any application would need to be supported by a bushfire hazard assessment, a bushfire landscape assessment and a bushfire management statement. Given the extent of vegetation on the site careful consideration will need to be given to the design and siting of any dwelling on the site.<br><br>Pursuant to the FZ, no permit would be required for the use of the land as a dwelling provided the requirements in Clause 35.07-2 are met. In addition, one small second dwelling would be permitted as of right provided the requirements in Clause 35.07 are met.|
|4|10649 / 534|Crown Allotment 26F Section C Parish of Monegeetta|0.74|FZ<br><br>Vegetation Protection Overlay (VPO)|A permit would be required to construct a dwelling on the site, one small second dwelling may also be permitted however would be subject to Council approval.<br><br>Given the relatively small lot size and irregular lot shape careful consideration will need to be given to the design and siting of any dwellings.<br><br>In addition, a permit would be required to remove any vegetation on site pursuant to the VPO.|
|5|9939 / 701|Crown Allotment 26C Section C Parish of Monegeetta|0.60|FZ|A permit would be required to construct a dwelling on the site. One small second dwelling may also be permitted however would be subject to Council approval.<br><br>Given the relatively small lot size and irregular lot shape careful consideration will need to be given to the design and siting of any dwellings.|
|6|9939 / 700|Crown Allotment 26B Section C Parish of Monegeetta|0.36|FZ|A permit would be required to construct a dwelling on the site. One small second dwelling may also be permitted however would be subject to Council approval.<br><br>Given the relatively small lot size and irregular lot shape careful consideration will need to be given to the design and siting of any dwellings.|
|7|9939 / 702|Crown Allotment 26D Section C Parish of Monegeetta|3.91|FZ|A permit would be required to construct a dwelling on the site. One small second dwelling may also be permitted however would be subject to Council approval.|
|8|11216 / 866|Lot 6 Plan of Subdivision 529130N|43.83|FZ<br><br>BMO|Pursuant to the BMO a permit would be required to construct a dwelling. Any application would need to be supported by a bushfire hazard assessment, a bushfire landscape assessment and a bushfire management statement. Given the extent of vegetation on the site careful consideration will need to be given to the design and siting of any dwelling on the site.<br><br>Pursuant to the FZ, no permit would be required for the use of the land as a dwelling provided the requirements in Clause 35.07-2 are met. In addition, one small second dwelling would be permitted as of right provided the requirements in Clause 35.07 are met.|
|9|11216 /865|Lot 5 Plan of Subdivision 529130N|40.05|FZ<br><br>BMO|Pursuant to the BMO a permit would be required to construct a dwelling. Any application would need to be supported by a bushfire hazard assessment, a bushfire landscape assessment and a bushfire management statement. Given the extent of vegetation on the site careful consideration will need to be given to the design and siting of any dwelling on the site.<br><br>Pursuant to the FZ, no permit would be required for the use of the land as a dwelling provided the requirements in Clause 35.07-2 are met. In addition, one small second dwelling would be permitted as of right provided the requirements in Clause 35.07 are met.|
|10|11216 / 864|Lot 4 Plan of Subdivision 529130N|40.03|FZ<br><br>BMO|Pursuant to the BMO a permit would be required to construct a dwelling. Any application would need to be supported by a bushfire hazard assessment, a bushfire landscape assessment and a bushfire management statement. Given the extent of vegetation on the site careful consideration will need to be given to the design and siting of any dwelling on the site.<br><br>Pursuant to the FZ, no permit would be required for the use of the land as a dwelling provided the requirements in Clause 35.07-2 are met. In addition, one small second dwelling would be permitted as of right provided the requirements in Clause 35.07 are met.|

In addition to the above, Clause 35.07-2 of the Farming Zone sets out the following mandatory requirements for dwellings.

- A lot used for a dwelling, small second dwelling or rural worker accommodation must meet the following requirements:

- Access to the dwelling, small second dwelling or rural worker accommodation must be provided via an all-weather road with dimensions adequate to accommodate emergency vehicles.
- Each dwelling, small second dwelling or rural worker accommodation must be connected to reticulated sewerage, if available. If reticulated sewerage is not available all wastewater from each dwelling must be treated and retained within the lot in accordance with the requirements of the Environment Protection Regulations under the Environment Protection Act 2017 for an on-site wastewater management system.
- The dwelling, small second dwelling or rural worker accommodation must be connected to a reticulated potable water supply or have an alternative potable water supply with adequate storage for domestic use as well as for fire fighting purposes.
- The dwelling, small second dwelling or rural worker accommodation must be connected to a reticulated electricity supply or have an alternative energy source.
